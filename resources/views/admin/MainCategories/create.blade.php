                                ...
                                <div class="card-body">
                                    <form class="form" action="{{route('admin.mainCategories.store')}}" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            @error('photo')
                                            <span class="text-danger">قم بإدخال الصورة</span>
                                            @enderror
                                        ...
                                        <div class="form-body">
                                            ...
                                            @if ((get_Language_Active() -> count()) >0)

                                            @foreach(get_Language_Active()  as $index => $lang)
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6 hidden">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"  id="translation_lang"
                                                               class="form-control"
                                                               placeholder="ادخل أختصار اللغة  " value="{{$lang->abbr}}" name="category[{{$index}}][translation_lang]">
