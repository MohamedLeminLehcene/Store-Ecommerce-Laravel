  ...
  <body id="index" class="lang-ar lang-rtl country-gb currency-gbp layout-full-width page-index tax-display-enabled">
	...
	<header id="header" class="header-3 sticky-menu">
		...
		<!-- Header Center -->
			...
			<!-- End H Center -->
			@include('front.Includes.header-top-center')
        ...
        <div class="content-boxpage col">
            ...
            <div>
                <div id="_mobile_account_list">
                  <div class="account-list-content">
                                        <div>
                      <a class="login" href="http://demo.bestprestashoptheme.com/savemart/ar/?????? ??????" rel="nofollow" title="Log in to your customer account"><i class="fa fa-sign-in"></i>Sign in</a>
                    </div>
                    <div>
                      <a class="register" href="http://demo.bestprestashoptheme.com/savemart/ar/?????? ??????" rel="nofollow" title="Register Account"><i class="fa fa-user"></i>Register Account</a>
                    </div>
                                        <div>
                      <a class="check-out" href="http://demo.bestprestashoptheme.com/savemart/ar/??? ????" rel="nofollow" title="Checkout"><i class="material-icons">check_circle</i>Checkout</a>
                    </div>
          ...
          <div id="box-currency" class="box-content d-flex">
            <div class="w-100">
                ...
                <a title="???? ????????" rel="nofollow" href="http://demo.bestprestashoptheme.com/savemart/ar/?home=home_3&amp;SubmitCurrency=1&amp;id_currency=1">???? ????????: GBP</a>
              </div>
                          <div class="item-currency">
                <a title="????? ??????" rel="nofollow" href="http://demo.bestprestashoptheme.com/savemart/ar/?home=home_3&amp;SubmitCurrency=1&amp;id_currency=2">????? ??????: USD</a>
              </div>
                        </div>
          </div>
          ...
          <div id="box-language" class="box-content d-flex">
            <div class="w-100">
                ...
                <a href="http://demo.bestprestashoptheme.com/savemart/ar/?home=home_3&SubmitCurrency=1&id_currency=1" class="d-flex align-items-center"><img class="img-fluid mr-2" src="/savemart/img/l/6.jpg" alt="????? ??????? (Arabic)" width="16" height="11" /><span>????? ???????</span></a>
              </div>
                        </div>
          </div>
